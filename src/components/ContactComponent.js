...
class Contact extends Component{
    ...
    validate(firstname, lastname, telnum, email){
        ...
        else if(this.state.firstname && firstname.length >20)
            errors.firstname = "Firstname should be<= 20 characters";

        if(this.state.lastname && lastname.length < 3)
            errors.lastname = "Firstname should be>= 3 characters";
        else if(this.state.lastname && lastname.length >20)
            errors.lastname = "Firstname should be<= 20 characters";
